package net.astralya.yeastnfeast.entity;
...
public class ModBoats {
    public static final Identifier MAPLE_BOAT_ID = new Identifier(YeastNFeastMod.MODID, "maple_boat");
    public static final Identifier MAPLE_CHEST_BOAT_ID = new Identifier(YeastNFeastMod.MODID, "maple_chest_boat");
