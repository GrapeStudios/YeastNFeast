...
public final class ModTags {
    ...
    public static final class Items {
        ...
        @Deprecated
        public static final TagKey<Item> GRAINS_WHEATS = cItemTag("grains/wheats");

        private static TagKey<Item> modItemTag(String path) {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of(YeastNFeastMod.MODID, path));
        }
    ...
    public static class Biomes {
        ...
        public static final TagKey<Biome> HAS_THISTLE = createBiomeTag("has_thistle");

        private static TagKey<Biome> createBiomeTag(String name) {
            return TagKey.of(RegistryKeys.BIOME, Identifier.of(YeastNFeastMod.MODID, name));
        }
    }
}