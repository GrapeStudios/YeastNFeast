...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, MAPLE_PLACED, configured.getOrThrow(ModConfiguredFeatures.MAPLE_TREE), rareTreePlacement(ModBlocks.MAPLE_SAPLING.get(), 25));
        register(context, LEMON_PLACED, configured.getOrThrow(ModConfiguredFeatures.LEMON_TREE), rareTreePlacement(ModBlocks.LEMON_SAPLING.get(), 25));
        register(context, HAWTHORN_PLACED, configured.getOrThrow(ModConfiguredFeatures.HAWTHORN_TREE), rareTreePlacement(ModBlocks.HAWTHORN_SAPLING.get(), 25));
    }

    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(YeastNFeastMod.MODID, name));
    }
