...
public class ModBiomeModifier {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_WILD_GINGER, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                ...
                GenerationStep.Decoration.VEGETAL_DECORATION));
        context.register(ADD_THISTLE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                HolderSet.direct(forestBiome.get()),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(YeastNFeastMod.MODID, name));
    }
