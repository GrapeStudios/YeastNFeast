...
public class KegCategory implements DisplayCategory<BasicDisplay> {
    ...
    public static final Identifier TEXTURE =
            new Identifier(YeastNFeastMod.MODID, "textures/gui/keg_gui_2.png");
    public static final CategoryIdentifier<KegDisplay> KEG =
            CategoryIdentifier.of(YeastNFeastMod.MODID, "keg");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.KEG.asItem().getDefaultStack());
    }
    ...
    public List<Widget> setupDisplay(BasicDisplay display, Rectangle bounds) {
        ...
        if (ingredientEntries != null && ingredientEntries.size() >= 3) {
            // Positions for each slot individually
