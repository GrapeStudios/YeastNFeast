...
public class YeastNFeastREIPlugin implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        registry.addWorkstations(CheesePressCategory.CHEESE_PRESS, EntryStacks.of(ModItems.CHEESE_PRESS));
    }

    @Override
    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(KegRecipe.class, ModRecipes.KEG_TYPE, KegDisplay::new);
        registry.registerRecipeFiller(CheesePressRecipe.class, ModRecipes.CHEESE_PRESS_TYPE, CheesePressDisplay::new);
    }
