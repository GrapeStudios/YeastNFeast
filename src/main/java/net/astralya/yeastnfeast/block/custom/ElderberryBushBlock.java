...
public class ElderberryBushBlock extends PlantBlock implements Fertilizable {
    ...
    public static final MapCodec<ElderberryBushBlock> CODEC = createCodec(ElderberryBushBlock::new);
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (age > 1) {
            ...
            Block.dropStack(world, pos, new ItemStack(ModItems.ELDERBERRIES, resourceCount + (atMax ? 1 : 0)));
