...
public class HawthornLeavesBlock extends Block implements Fertilizable, Waterloggable {
    ...
    public HawthornLeavesBlock(Settings settings) {
        super(settings);
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos,
        ...
        if (age == MAX_AGE) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.HAWTHORN_BERRIES, resourceCount + 1));
