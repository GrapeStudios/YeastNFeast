...
public class ModItems {
    ...
    public static final Item MAPLE_SYRUP = registerItem("maple_syrup",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.MAPLE_SYRUP).recipeRemainder(Items.GLASS_BOTTLE).maxCount(16)));
    public static final Item MOLASSES = registerItem("molasses",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.MOLASSES).recipeRemainder(Items.GLASS_BOTTLE).maxCount(16)));
    public static final Item MILK_BOTTLE = registerItem("milk_bottle",
            new MilkBottleItem(new Item.Settings().recipeRemainder(Items.GLASS_BOTTLE).maxCount(16)));
    ...
    public static final Item SWEET_PORRIDGE = registerItem("sweet_porridge",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.SWEET_PORRIDGE),
    ...
    public static final Item SPICED_PORRIDGE = registerItem("spiced_porridge",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.SPICED_PORRIDGE),
                    ()-> ModEffects.OVERFED, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.bowl").formatted(Formatting.BLUE)));
    public static final Item BARLEY_AND_BEEF_STEW = registerItem("barley_and_beef_stew",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.BARLEY_AND_BEEF_STEW),
                    ()-> ModEffects.OVERFED, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.bowl").formatted(Formatting.BLUE)));
    public static final Item SALMON_CHOWDER = registerItem("salmon_chowder",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.SALMON_CHOWDER),
                    ()-> ModEffects.OVERFED, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.bowl").formatted(Formatting.BLUE)));

    // Plated Food Items
    public static final Item MEAD_BRAISED_PORK = registerItem("mead_braised_pork",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.MEAD_BRAISED_PORK),
    ...
    public static final Item HERBAL_COD = registerItem("herbal_cod",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.HERBAL_COD),
                    ()-> ModEffects.VIGOROUS, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.plate").formatted(Formatting.BLUE)));
    public static final Item LEMON_GLAZED_CHICKEN = registerItem("lemon_glazed_chicken",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.LEMON_GLAZED_CHICKEN),
                    ()-> ModEffects.VIGOROUS, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.plate").formatted(Formatting.BLUE)));
    public static final Item FORAGER_FEAST = registerItem("forager_feast",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.FORAGER_FEAST),
                    ()-> ModEffects.VIGOROUS, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.plate").formatted(Formatting.BLUE)));
    public static final Item MAPLE_GLAZED_RABBIT = registerItem("maple_glazed_rabbit",
            new FeastItem(new Item.Settings().maxCount(1).food(ModFoodComponents.MAPLE_GLAZED_RABBIT),
                    ()-> ModEffects.VIGOROUS, 4800, 0,
                    Text.translatable("tooltip.yeastnfeast.feast_item.plate").formatted(Formatting.BLUE)));
    ...
    public static final Item HONEY_MEAD = registerItem("honey_mead",
            new MeadItem(new Item.Settings().maxCount(16), ()-> StatusEffects.RESISTANCE, 7200, 1,
    ...
    public static final Item SOUR_MEAD = registerItem("sour_mead",
            new MeadItem(new Item.Settings().maxCount(16), ()-> StatusEffects.STRENGTH, 7200, 1,
    ...
    public static final Item BLOSSOM_MEAD = registerItem("blossom_mead",
            new MeadItem(new Item.Settings().maxCount(16), ()-> StatusEffects.REGENERATION, 4800, 1,
    ...
    public static final Item APPLE_JAM = registerItem("apple_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.APPLE_JAM).maxCount(16)));
    public static final Item CHORUS_FRUIT_JAM = registerItem("chorus_fruit_jam",
            new ChorusFruitJamItem(new Item.Settings().food(ModFoodComponents.CHORUS_FRUIT_JAM).maxCount(16)));
    public static final Item ELDERBERRIES_JAM = registerItem("elderberries_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.ELDERBERRIES_JAM).maxCount(16)));
    public static final Item GLOW_BERRIES_JAM = registerItem("glow_berries_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.GLOW_BERRIES_JAM).maxCount(16)));
    public static final Item GOLDEN_APPLE_JAM = registerItem("golden_apple_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.GOLDEN_APPLE_JAM).maxCount(16)));
    public static final Item HAWTHORN_BERRIES_JAM = registerItem("hawthorn_berries_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.HAWTHORN_BERRIES_JAM).maxCount(16)));
    public static final Item LEMON_JAM = registerItem("lemon_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.LEMON_JAM).maxCount(16)));
    public static final Item MELON_JAM = registerItem("melon_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.MELON_JAM).maxCount(16)));
    public static final Item ROSE_HIPS_JAM = registerItem("rose_hips_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.ROSE_HIPS_JAM).maxCount(16)));
    public static final Item SWEET_BERRIES_JAM = registerItem("sweet_berries_jam",
            new ConsumableItem(new Item.Settings().food(ModFoodComponents.SWEET_BERRIES_JAM).maxCount(16)));
