...
public class ModVillagers {
    ...
    private static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registries.VILLAGER_PROFESSION, new Identifier(YeastNFeastMod.MOD_ID, name),
    ...
    private static PointOfInterestType registerPoi(String name, Block block) {
        return PointOfInterestHelper.register(new Identifier(YeastNFeastMod.MOD_ID, name),
                1, 1, block);
    }

    private static RegistryKey<PointOfInterestType> registerPoiKey(String name) {
        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, new Identifier(YeastNFeastMod.MOD_ID, name));
    }


    public static void registerVillager() {
        YeastNFeastMod.LOGGER.info("Registering Villager for " + YeastNFeastMod.MOD_ID);
    }
}
