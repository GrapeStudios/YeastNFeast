...
public class ModAdvancementsProvider implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        ...
        Advancement kegAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, new ResourceLocation(YeastNFeastMod.MOD_ID, "keg"), existingFileHelper);
        ...
        Advancement sweetAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, new ResourceLocation(YeastNFeastMod.MOD_ID, "sweet"), existingFileHelper);
        ...
        Advancement sourAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, new ResourceLocation(YeastNFeastMod.MOD_ID, "sour"), existingFileHelper);
        ...
        Advancement floralAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, new ResourceLocation(YeastNFeastMod.MOD_ID, "floral"), existingFileHelper);
        ...
        Advancement jarAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, new ResourceLocation(YeastNFeastMod.MOD_ID, "jar"), existingFileHelper);
        ...
        Advancement mapleAdvancement = Advancement.Builder.advancement()
                ...
                .save(saver, new ResourceLocation(YeastNFeastMod.MOD_ID, "maple"), existingFileHelper);
    }
}
