...
public class ModRegistries {
    public static void registerCompostables() {
        ...
        ComposterBlock.COMPOSTABLES.put(ModItems.ELDERBERRIES.get(), 0.5f);
        ComposterBlock.COMPOSTABLES.put(ModItems.HAWTHORN_BERRIES.get(), 0.5f);
        ComposterBlock.COMPOSTABLES.put(ModItems.ROSE_HIPS.get(), 0.5f);
