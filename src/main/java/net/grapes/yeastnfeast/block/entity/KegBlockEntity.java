...
import net.grapes.yeastnfeast.screen.KegScreenHandler;
...
public class KegBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    private Optional<KegRecipe> getCurrentRecipe() {
        ...
        return Objects.requireNonNull(this.getWorld()).getRecipeManager().getFirstMatch(KegRecipe.Type.INSTANCE, inventory, this.getWorld());
    }
