...
public class ModBoats {
    public static final Identifier MAPLE_BOAT_ID = new Identifier(YeastNFeastMod.MOD_ID, "maple_boat");
    public static final Identifier MAPLE_CHEST_BOAT_ID = new Identifier(YeastNFeastMod.MOD_ID, "maple_chest_boat");
