...
public class ModFoodProperties {
    ...
    public static FoodProperties BARLEY_BREAD = new FoodProperties.Builder().nutrition(6).saturationMod(0.7f).build();
    ...
    public static FoodProperties ROSE_PIE = new FoodProperties.Builder().nutrition(6).saturationMod(0.4f).build();
