...
public class ModFoodProperties {
    ...
    public static FoodProperties BARLEY_BREAD = new FoodProperties.Builder().nutrition(5).saturationMod(0.7f).build();
    public static FoodProperties RYE_BREAD = new FoodProperties.Builder().nutrition(5).saturationMod(0.7f).build();
    public static FoodProperties CHOCOLATE_BUN = new FoodProperties.Builder().nutrition(5).saturationMod(0.7f).build();
